...
Процедура Инициализация()
	...
	// Параметры.Вставить("ЛеваяИБ", ЛеваяИБ);
	...
	КонецЦикла;
	// Параметры.Вставить("ПраваяИБ", ПраваяИБ);
...
Процедура Выполнение()
	...
	ВыгрузитьМетаданные("left");
	Лог.Информация("Выгружается МД из правой ИБ");
	ВыгрузитьМетаданные("right");
	КомСтрока = СтрЗаменить(Параметры["diffTool"], "{LEFT}", "left");
	КомСтрока = СтрЗаменить(КомСтрока, "{RIGHT}", "right");
